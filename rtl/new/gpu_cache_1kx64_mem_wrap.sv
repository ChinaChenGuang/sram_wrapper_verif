// ============================================================
// gpu_cache_1kx64_mem_wrap - New (Replacement with ECC)
// ============================================================
// 1K-depth x 64-bit cache SRAM for GPU
// ADDR_WIDTH = 10, DATA_WIDTH = 64
// New: adds ECC protection internally
// ============================================================

`timescale 1ns/1ps

module gpu_cache_1kx64_mem_wrap #(
    ...
    always_ff @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            // ECC check (stub) - same interface, different impl
