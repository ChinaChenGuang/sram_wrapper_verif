// ============================================================
// sram_bitwrite - TDP SRAM with per-bit write mask (2K×16)
// ============================================================
// Standard TDP interface with explicit per-bit write mask.
// ADDR_WIDTH=11, DATA_WIDTH=16
// Orig: active-low wem (0=write, 1=mask) — compatible with env
// ============================================================
...
module sram_bitwrite #(
    ...
    // Bit-level write (explicit per-bit)
