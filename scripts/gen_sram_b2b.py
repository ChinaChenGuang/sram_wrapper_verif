...
def generate_makefile_frag(instances: list, cfg: dict, enabled_only: bool = True) -> str:
    ...
    # Collect all generated DUT source files
    dut_srcs = []
    ...
    lines.append("# Per-instance DUT module names (for +define+)")
...
def main():
    ...
    # Phase 2: Generate Makefile fragment
